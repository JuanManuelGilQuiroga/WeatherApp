export function Cloudy ({style}) {
    return (
        <svg className={style} viewBox="0 0 81 107" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path fill-rule="evenodd" clip-rule="evenodd" d="M20.5044 74.9201C20.9168 68.6713 23.2684 62.7068 27.2314 57.8579C31.1945 53.009 36.5715 49.5172 42.6131 47.8692C48.6547 46.2211 55.06 46.4989 60.9363 48.6638C66.8125 50.8288 71.867 54.7729 75.3954 59.9467C71.8931 66.1138 66.8183 71.2419 60.6882 74.8086C54.5582 78.3752 47.5921 80.2528 40.5 80.25C33.2173 80.25 26.3894 78.3106 20.5044 74.9201Z" fill="url(#paint2_linear_1_811)"/>
        <path fill-rule="evenodd" clip-rule="evenodd" d="M50.5312 107C50.5312 100.349 47.8891 93.9701 43.186 89.2671C38.483 84.564 32.1043 81.9219 25.4531 81.9219C18.802 81.9219 12.4233 84.564 7.72021 89.2671C3.01715 93.9701 0.375 100.349 0.375 107C0.411781 106.943 50.5446 106.96 50.5312 107Z" fill="#F1F3F4"/>
        <defs>
